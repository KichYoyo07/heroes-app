...
export const SearchControls = () => {
    ...
    const seletedStrength = Number(searchParams.get('strength') ?? '0');
    ...
    const handleKeyDown = (event: React.KeyboardEvent<HTMLInputElement>) => {
        if (event.key === 'Enter') {
            const value = inputRaf.current?.value ?? '';
            // setSearchParams(prev => {
            //     prev.set('name', value);
            //     return prev;
            // });
                ...
                <AccordionItem value='advance-filters'>
                    ...
                    <AccordionContent>
                        <div className='bg-white rounded-lg p-6 mb-8 shadow-sm border'>
                            ...
                            <div className='mt-4'>
                                <label className='text-sm font-medium'>Minimum Strength: {seletedStrength}/10</label>
                                <Slider
                                    defaultValue={[seletedStrength]}
